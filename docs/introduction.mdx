---
title: Documentation
description: Bienvenido a la documentación oficial de Apuntafy. Aquí encontrarás recursos para aprender a usar Apuntafy para agendar citas en tu negocio. También hemos incluido documentación avanzada sobre cómo integrar y extender Apuntafy mediante API. Estas guías te ayudarán a aprovechar al máximo Apuntafy para las necesidades de tu empresa.
hugeTitle: true
fullWidth: true
omitFeedback: true
---
